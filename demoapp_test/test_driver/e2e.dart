...
void main() {
  group('Counter App', () {
    ...
    final counterTextFinder = find.byValueKey('counter_tester');
    final buttonFinder = find.byValueKey('increment_tester');
    ...
    test(' ', () async {
      ...
      await driver?.scroll(
          find.byType('ListView'), 50, 100, const Duration(milliseconds: 200),
          frequency: 30);
